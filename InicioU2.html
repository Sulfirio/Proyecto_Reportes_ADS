...
<html>
  <head>
    ...
    <script src="js/funListEstimacionesSupe.js"></script>
    <script src="js/funAprobar.js"></script>
    <script src="js/FunAprobarRepo.js"></script>
    ...
    <header>
      ...
      <nav>
        <ul>
          ...
          <li><a href="#Aprobar_Estimacion">Aprobar Estimacion</a></li>
          <li><a href="#Aprobar_Reportes">Aprobar Reportes</a></li>
...
<!--***************************************Aprobar_Reportes******************************************-->
<section id="Aprobar_Reportes">
  <select id="aproRepor" name="nuM">
  </select>
  <div id="tablaReportes"></div>
  <button id="btnAceptarRepo" style="display:none">Aceptar</button>
  <button id="btnRechazarRepo" style="display:none">Rechazar</button>
</section>
<!--**************************************************************************************************-->
    </main>
